...
const Failure = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.Text animation="fadeInUp" delay={300} style={styles.title} testID="failureTitle">
        Payment Failed
      </Animatable.Text>

      <Animatable.Text animation="fadeInUp" delay={500} style={styles.subText} testID="failureSubText">
        Your transaction could not be completed
      </Animatable.Text>

      <Animatable.View animation="fadeInUp" delay={700}>
        <TouchableOpacity style={styles.tryAgainButton} onPress={handleTryAgain}  testID="tryAgainButton">
          <Text style={styles.tryAgainText}>Try Again</Text>
        </TouchableOpacity>
      </Animatable.View>

      <Animatable.View animation="fadeInUp" delay={900}>
        <TouchableOpacity style={styles.backHomeButton} onPress={handleNavigate} testID="backHomeButton">
          <Text style={styles.backHomeText}>Back to Home</Text>
        </TouchableOpacity>
      </Animatable.View>
    </View>
