...
type AdminScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'AdminScreen'>;
    ...
    <SafeAreaView style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListFooterComponent={() => (loadingMore ? <ActivityIndicator size="small" color="#FF0000" /> : null)}
